        ...
        if is_document:
            ...
            if redirect_url:
                ...
                if not redirect_url.startswith("http"):
                    ...
                    if not G.has_node(redirect_url):
                        G.add_node(redirect_url, label=redirect_label, title=redirect_url, group="redirect")
                    
                    G.add_edge(url, redirect_url, label="redirects to", dashes=True)
